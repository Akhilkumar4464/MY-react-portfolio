...
function About() {
  ...
  return (
    <div className="bg-transparent backdrop-blur-2xl text-gray-900 dark:text-gray-100 p-6 rounded-lg shadow-md">
      <section className="bg-transparent py-16 px-6 max-w-4xl mx-auto">
      ...
      <section className="bg-transparent py-16 px-6 max-w-4xl mx-auto flex flex-col md:flex-row gap-8">
        <div className="flex-1">
          <h3 className="text-2xl font-bold mb-4">Skills</h3>
          <ul className="list-disc pl-6 space-y-2"> 
            {skills.map((skill) => (
              <li key={skill.name} className="flex   items-center gap-2">
                <span className="text-lg hover:animate-spin ">{skill.icon}</span>
        ...
        <div className="flex-1 hover:animate-bounce text-gray-900 dark:text-gray-100">
          <h3 className="text-2xl font-bold mb-4 hover:animate-ping">Experience</h3>
