...
function About() {
  ...
  return (
    <motion.div
      className="bg-transparent backdrop-blur-2xl text-gray-900 dark:text-gray-100 p-6 rounded-lg shadow-md"
    ...
    >
      ...
      <section className="bg-transparent py-16 px-6 max-w-4xl mx-auto flex flex-col md:flex-row gap-8">
        ...
        <div className="flex-1 sm:hover:scale-105 text-gray-900 dark:text-gray-100">
